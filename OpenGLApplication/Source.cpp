...
int main()
{
	...
	Shader simpleDepthShader("C:/Users/antox/source/repos/OpenGLApplication/OpenGLApplication/shadow_mapping.vert",
							 ...
							 "C:/Users/antox/source/repos/OpenGLApplication/OpenGLApplication/shadow_mapping.geom");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightPos.x = sin(glfwGetTime()) + 0.8 * 1.41;
		lightPos.y = sin(glfwGetTime()) + 0.2 * 1.2;
		lightPos.z = sin(glfwGetTime()) + 0.5 * 1.32;
