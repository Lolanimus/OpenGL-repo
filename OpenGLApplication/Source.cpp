...
int main()
{
	...
	Shader simpleDepthShader("C:/Users/antox/source/repos/OpenGLApplication/OpenGLApplication/shadow_mapping.vert",
					         "C:/Users/antox/source/repos/OpenGLApplication/OpenGLApplication/shadow_mapping.frag");
	Shader debugDepthQuad("C:/Users/antox/source/repos/OpenGLApplication/OpenGLApplication/quad_depth.vert",
						  "C:/Users/antox/source/repos/OpenGLApplication/OpenGLApplication/quad_depth.frag");
	float planeVertices[] = {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Render of scene to depth texture
		...
		glBindFramebuffer(GL_FRAMEBUFFER, depthMapFBO);
			...
			glBindTexture(GL_TEXTURE_2D, floorTextureSRGB);
			glCullFace(GL_FRONT);
